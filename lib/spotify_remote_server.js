...
SpotifyRemoteServer.prototype.handleConnection = function(socket) {
  ...
  socket.on('muteVolume', this.muteVolume.bind(this));
  socket.on('unmuteVolume', this.unmuteVolume.bind(this));
...
SpotifyRemoteServer.prototype.muteVolume = function(volume) {
  this.spotify.muteVolume(this.getCurrentState.bind(this));
};

SpotifyRemoteServer.prototype.unmuteVolume = function(volume) {
